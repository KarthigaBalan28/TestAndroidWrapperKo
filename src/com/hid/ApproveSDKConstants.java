...
public class ApproveSDKConstants {
	...
	public static final String HID_FINGERPRINT_AUTHENTICATION_REQUIRED_EXCEPTION = "FingerprintAuthenticationRequiredException";
	public static final String HID_REMOTE_EXCEPTION = "RemoteException";
	public static final String HID_SERVER_OPERATION_FAILED_EXCEPTION = "ServerOperationFailedException";
	public static final String HID_SERVER_UNSUPPORTED_OPERATION_EXCEPTION = "ServerUnsupportedOperationException";
	public static final String HID_FINGERPRINT_NOT_ENROLLED_EXCEPTION = "FingerprintNotEnrolledException";
	public static final String HID_PASSWORD_EXPIRED_EXCEPTION = "PasswordExpiredException";
	public static final String HID_PASSWORD_REQUIRED_EXCEPTION = "PasswordRequiredException";
	public static final String HID_INAVLID_CONTAINER_EXCEPTION = "InvalidContainerException";
	public static final String HID_INEXPLICIT_CONTAINER_EXCEPTION = "InexplicitContainerException";
